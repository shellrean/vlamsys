...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])('ujian', ['getUjianByBanksoal']), {}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])('banksoal', ['getAllBanksoals']), {}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapMutations"])(['CLEAR_ERROR', 'SET_LOADING']), {
    getDataJadwals: function getDataJadwals() {
      var _this = this;

      this.isBusy = true;
      this.getUjianByBanksoal(this.banksoal).then(function () {
        _this.isBusy = false;
      });
    }
  }),
                    ...
                    _c(
                      ...
                      [
                        _vm.ujians.data && _vm.ujians.data.length > 0
                          ? _c("b-pagination", {
                              attrs: {
                                "total-rows": _vm.ujians.total,
                                "per-page": _vm.ujians.per_page,
